...
public class tryoutDetailPull extends ViewGroup {

    private final static String TAG = tryoutDetailPull.class.getName();

    TryoutDetailScroll topScrollView, bottomScrollView;
    VelocityTracker velocityTracker = VelocityTracker.obtain();//追踪手指滑动速度
    ...
    public tryoutDetailPull(Context context) {
        super(context);
        init();
    }
    public tryoutDetailPull(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    public tryoutDetailPull(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void init() {
        post(new Runnable() {
            @Override
            public void run() {
                topScrollView = (TryoutDetailScroll) getChildAt(0);
                bottomScrollView = (TryoutDetailScroll) getChildAt(1);

                topScrollView.setScrollListener(new TryoutDetailScroll.ScrollListener() {
                    @Override
                ...
                bottomScrollView.setScrollListener(new TryoutDetailScroll.ScrollListener() {
                    @Override
                    public void onScrollToBottom() {
